        ...
        <div class="col">
            <div class="product-grid p-0 ">
                <div class="product-image">
                    <a class="image">
                        <img src="{{ $article->images->isNotEmpty() ? $article->images->first()->getUrl(800, 800) : 'https://picsum.photos/700/600'}}" class="img-fluid rounded-bottom-1 card-img-top" alt="Immagine dell'articolo: {{ $article->title }}">
                    </a>
