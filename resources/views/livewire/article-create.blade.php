    ...
    <div class="row g-0 align-items-stretch rounded-4 overflow-hidden mw-1200 w-100 mx-auto px-3 px-md-0 position-relative" style="top: 4rem;">
            ...
            <form wire:submit="store" class="form-custom">
                <div class="row">
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control custom-input w-full text-sm focus:ring-2 focus:ring-primary focus:border-transparent" id="title" wire:model.live="title"
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end dropdown-animation max-h-60 overflow-y-auto"
                                ...
                                @forelse ($categories as $category)
                                    <li>
                                        <a class="dropdown-item text-sm hover:bg-primary hover:text-white transition-colors" href="#"
                    ...
                    @if (!empty($images))
                        <div class="row">
                            <div class="col-12">
                                <p class="text-sm">Photo preview:</p>
                                <div class="row border border-4 border-success rounded shadow py-4 overflow-x-auto">
                                    @foreach ($images as $key => $image)
                                        <div class="col-auto d-flex flex-column align-items-center my-3 mx-2">
                                            <div class="img-preview mx-auto shadow rounded w-24 h-24 bg-cover bg-center transition-transform duration-300 hover:scale-110"
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control custom-input text-sm w-full focus:ring-2 focus:ring-primary focus:border-transparent" id="description" wire:model.live="description" rows="4"
                    ...
                    <div class="col-12 col-md-8 mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control custom-input text-sm w-full focus:ring-2 focus:ring-primary focus:border-transparent" step="0.01" id="price"
                                wire:model.live="price" placeholder="0.00">
                            <div class="dropdown">
                                <button class="btn dropdown-toggle custom-input text-sm" type="button" id="currencyDropdown"
