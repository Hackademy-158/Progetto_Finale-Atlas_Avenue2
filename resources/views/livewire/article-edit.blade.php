            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-6">
                    <form wire:submit="update">
                        ...
                        <img src="{{ $article->images->isNotEmpty() ? $article->images->first()->getUrl(800, 800) : 'https://picsum.photos/700/600' }}"
                            alt="Immagine di {{ $article->title }}" style="width: 100%;" class="mb-3">
                        <div class="mb-3">
                        ...
                        <a class="btn btn-secondary mt-3"
                            href="{{ route('article.show', compact('article')) }}">Indietro</a>
                    </form>
                </div>
            </div>
        </div>
